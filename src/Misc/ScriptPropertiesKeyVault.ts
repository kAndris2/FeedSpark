export class ScriptPropertiesKeyVault {
    ...
    public static readonly youtubeChannelAvatarUrlTemplate: string = "YoutubeChannelAvatarUrlTemplate";
    public static readonly youtubeChannelBannerUrlTemplate: string = "YoutubeChannelBannerUrlTemplate";
}